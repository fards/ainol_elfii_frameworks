...
public final class RIL extends BaseCommands implements CommandsInterface {
    ...
    //***** property for dns,addr
    private static final String IFNAME_PROP_NAME="ril.ifname";
    ...
    public RIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        ...
        boolean hasNoPhone = SystemProperties.getBoolean("hw.nophone", true) ;
...
*/
    ...
    responseSetupDataCall(Parcel p) {
        ...
        if (ver < 5) {
            ...
            dataCall.ifname = SystemProperties.get(IFNAME_PROP_NAME, "ppp0") ;
            String addresses = p.readString();
            if (!TextUtils.isEmpty(addresses)) {
              dataCall.addresses = addresses.split(" ");
            }
            else{
                addresses = SystemProperties.get("net."+dataCall.ifname+".local-ip", "") ;
                if (!TextUtils.isEmpty(addresses)) {
                    dataCall.addresses = addresses.split(" ");
                }
            }
