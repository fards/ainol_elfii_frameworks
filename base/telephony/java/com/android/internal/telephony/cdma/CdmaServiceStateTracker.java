        ...
        try{
            if (mDesiredPowerState
                ...
                powerOffRadioSafely(dcTracker);
                    ...
                    && cm.getRadioState() != CommandsInterface.RadioState.RADIO_OFF){
                cm.setRadioPower(true, null);
                ServiceState temp = new ServiceState();
                temp.setStateOutOfService();
                ss.setState(ServiceState.STATE_OUT_OF_SERVICE);
                phone.notifyServiceStateChanged(temp);
            }
            else {
                ServiceState temp = new ServiceState();
                temp.setStateOff();
            ...
            Log.d(LOG_TAG, "[CdmaServiceStateTracker] setPowerStateToDesired :"+e);
            return ;
        }
    }
