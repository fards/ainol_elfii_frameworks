...
void NativeInputManager::setMouseStatus(bool enabled) {
    { // acquire lock
        ...
        LOGI("Setting cursor input to %s.", enabled ? "enabled" : "disabled");
...
static int android_server_InputManager_nativeSetMouseCursorType(JNIEnv* env,
        jclass clazz, jint type) {
    return gNativeInputManager->setMouseCursorType(type);
}

static int android_server_InputManager_nativeGetMouseCursorType(JNIEnv* env, jclass clazz) {
    return gNativeInputManager->getMouseCursorType();
}

static void android_server_InputManager_nativeSetMouseStatus(JNIEnv* env,
        jclass clazz, jboolean enabled) {
    gNativeInputManager->setMouseStatus(enabled);
}
...
static JNINativeMethod gInputManagerMethods[] = {
    ...
    { "nativeSetMouseCursorType","(I)I",
            (void*) android_server_InputManager_nativeSetMouseCursorType},
    { "nativeGetMouseCursorType","()I",
            (void*) android_server_InputManager_nativeGetMouseCursorType},
    { "nativeSetMouseStatus","(Z)V",
            (void*) android_server_InputManager_nativeSetMouseStatus},
};
