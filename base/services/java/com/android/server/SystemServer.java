...
import com.android.server.RemoteControlService;
    ...
    public void run() {
        ...
        ActivityManagerService.self().systemReady(new Runnable() {
            public void run() {
	            ...
	            //ServiceManager.addService("remotecontrol", new RemoteControlService(context));
				RemoteControlService remoteControlService = new RemoteControlService(contextF);
