...
// IMPORTANT - the GPS_DELETE_* symbols here must match constants in gps.h
    ...
    public boolean sendExtraCommand(String command, Bundle extras) {
        ...
        if ("delete_aiding_data".equals(command)) {
		    ...
		    String prop = SystemProperties.get("ro.board.gps.module", "none");
		    if(prop.equalsIgnoreCase("AR1520")){

	        	/* for ATHR GPS $PUNV & OAP200 commands, jhung */
	        	if (native_supports_xtra()) {
	                  Log.d(TAG, "sendExtraCommand command found");
			          Binder.restoreCallingIdentity(identity);
	                  result = athrxtraDownloadRequest(command);
	        	}

	        	/* end of ATHR commands, jhung */
		    }
		    else
...
//        Log.d(TAG, "athrxtraDownloadRequest - data: " + cmd);
