    ...
    private void loadSettingsLocked() {
        ...
        if (mWidth < baseSize) {
            if(mContext.getResources().getInteger(com.android.internal.R.integer.config_defaultWallPaper_width) > 0)
                mWidth = mContext.getResources().getInteger(com.android.internal.R.integer.config_defaultWallPaper_width);
            else
                mWidth = baseSize;
        }
        if (mHeight < baseSize) {
            if(mContext.getResources().getInteger(com.android.internal.R.integer.config_defaultWallPaper_height) > 0)
                mHeight = mContext.getResources().getInteger(com.android.internal.R.integer.config_defaultWallPaper_height);
            else
                mHeight = baseSize;
        }
    }
