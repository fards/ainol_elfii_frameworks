...
public class InputManager implements Watchdog.Monitor {
    ...
    private static native int nativeSetMouseCursorType(int type);
    private static native int nativeGetMouseCursorType();
    private static native void nativeSetMouseStatus(boolean enabled);
    ...
    public int setMouseCursorType(int type){
        return nativeSetMouseCursorType(type);
    }

    public int getMouseCursorType(){
        return nativeGetMouseCursorType();
    }

    public void setMouseStatus(boolean enabled){
        nativeSetMouseStatus(enabled);
    }
