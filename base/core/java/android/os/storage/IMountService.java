...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        ...
        static final int TRANSACTION_getVolumeLabel = IBinder.FIRST_CALL_TRANSACTION + 33;

        static final int TRANSACTION_getVolumeFSLabel = IBinder.FIRST_CALL_TRANSACTION + 34;
        
        static final int TRANSACTION_isUsbMassStorageAllEnabled = IBinder.FIRST_CALL_TRANSACTION + 35;        
        /**
