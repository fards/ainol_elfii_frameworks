...
final class BluetoothAdapterStateMachine extends StateMachine {
    ...
    // Bluetooth Poweron timeout happens
    private static final int POWER_ON_TIMEOUT = 106;
    ...
    private static final int POWER_ON_TIMEOUT_TIME = 3000;
        ...
        public boolean processMessage(Message message) {
            ...
            switch(message.what) {
                ...
                case TURN_ON_CONTINUE:
                    ...
                    //if it does not transition to Bluetooth on in 5s, recover
                    sendMessageDelayed(POWER_ON_TIMEOUT, new Boolean(false), POWER_ON_TIMEOUT_TIME);
                    break;
                case AIRPLANE_MODE_ON:
                case TURN_COLD:
                    shutoffBluetooth();
        ...
        public boolean processMessage(Message message) {
            ...
            switch(message.what) {
                case SCAN_MODE_CHANGED:
                    removeMessages(POWER_ON_TIMEOUT_TIME);
                ...
                case POWER_ON_TIMEOUT:
                    Log.e(TAG, "Devices failed to power on, reseting...");
