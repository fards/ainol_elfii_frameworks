...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_TV_SHORTCUTKEY_GLOBALSETUP      =211;
    
    public static final int KEYCODE_TV_SHORTCUTKEY_SOURCE_LIST    =212;
    
    public static final int KEYCODE_TV_SHORTCUTKEY_3DMODE  = 213;
    
    public static final int KEYCODE_TV_SHORTCUTKEY_DISPAYMODE     = 214;
    
    public static final int KEYCODE_TV_SHORTCUTKEY_VIEWMODE       =215;
    
    public static final int KEYCODE_TV_SHORTCUTKEY_VOICEMODE       =216;   
    
    public static final int KEYCODE_TV_SHORTCUTKEY_TVINFO      = 217;
    
    public static final int KEYCODE_EARLY_POWER     = 218;
    
    public static final int KEYCODE_TV_SLEEP = 219;

	public static final int KEYCODE_TV_SOUND_CHANNEL = 220;

	public static final int KEYCODE_TV_REPEAT = 221;
