...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    public final int getPointerId(int pointerIndex) {
    	if( pointerIndex >= getPointerCount() )
    	{
    		Log.v("MotionEvent", "getPointerId out of index:" + pointerIndex + ", count:" + getPointerCount());
			return 0;
    	}else
    ...
    public final float getX(int pointerIndex) {
    	if(pointerIndex>=getPointerCount())
    	{
    		Log.v("MotionEvent","jeff out of index,apk should avoid it");
			return 10000f;
    	}else
