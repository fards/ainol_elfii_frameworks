...
public class View implements Drawable.Callback, Drawable.Callback2, KeyEvent.Callback,
    ...
    */
    ...
    protected void initializeScrollbars(TypedArray a) {
        ...
        boolean fadeScrollbars = a.getBoolean(R.styleable.View_fadeScrollbars, true);

        scrollabilityCache.scrollBarFadeDuration = a.getInt(
                R.styleable.View_scrollbarFadeDuration, ViewConfiguration
                        .getScrollBarFadeDuration());
        if (fadeScrollbars && (scrollabilityCache.scrollBarFadeDuration > 3600000 ||
                scrollabilityCache.scrollBarFadeDuration == 0)) {
            fadeScrollbars = false;
            scrollabilityCache.scrollBarFadeDuration = ViewConfiguration.getScrollBarFadeDuration();
        }
