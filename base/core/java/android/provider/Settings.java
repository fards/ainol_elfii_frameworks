...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public synchronized static String getString(ContentResolver resolver, String name) {
        	//hack by junsheng.xu: ------------begin------------
        	if(name.startsWith("ro.ubootenv.varible.prefix.") && resolver == null)
		{
			String attr = new String("ro.ubootenv.varible.prefix.");
			int len = attr.length();
			String varible = name.substring(len);
			String prefix = SystemProperties.get("ro.ubootenv.varible.prefix");
			final String value = SystemProperties.get(prefix + "." + varible);  
			return value;
		}
		else if(name.startsWith("getSystemProp.") && resolver == null)
        	{
        		String str = new String("getSystemProp.");
        		int len = str.length();
        		String varible = name.substring(len);
        		final String value = SystemProperties.get(varible);
        		return value;
        	}
		//hack by junsheng.xu: ------------end------------
        ...
        public static void getConfiguration(ContentResolver cr, Configuration outConfig) {
			...
			Log.v("jeff","fontScale"+outConfig.fontScale);
            if (outConfig.fontScale < 0) {
                outConfig.fontScale = Float.parseFloat(SystemProperties.get("ro.fontScale","1"));
            }
        }
         ...
         * CPU settings.
         */
        public static final String CPU_MODE = "cpu_mode";
