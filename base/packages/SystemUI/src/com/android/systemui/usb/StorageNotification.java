...
public class StorageNotification extends StorageEventListener {
    ...
    private void onUsbMassStorageConnectionChangedAsync(boolean connected) {
        ...
        Slog.i(TAG, String.format("UMS connection changed to %s (media state %s %s)", connected, st, intst));
        ...
        if ((Resources.getSystem().getBoolean(com.android.internal.R.bool.config_storage_notification)) && !connected)
        {
			setMediaStorageNotification(
						com.android.internal.R.string.usb_storage_disconnect_notification_title,
						com.android.internal.R.string.usb_storage_disconnect_notification_message,
    ...
    private void onStorageStateChangedAsync(String path, String oldState, String newState) {
        ...
        if (newState.equals(Environment.MEDIA_SHARED)) {
            ...
            if (!(Resources.getSystem().getBoolean(com.android.internal.R.bool.config_storage_notification))){
                 ...
                 setUsbStorageNotification(
                         com.android.internal.R.string.usb_storage_stop_notification_title,
                         com.android.internal.R.string.usb_storage_stop_notification_message,
                         com.android.internal.R.drawable.stat_sys_warning, true, true, pi);
            }
                ...
                if (oldState.equals(Environment.MEDIA_SHARED)) {
                    ...
                    if (Environment.isExternalStorageRemovable()) {
                        ...
                        if (!(Resources.getSystem().getBoolean(com.android.internal.R.bool.config_storage_notification))){
                            ...
                            setMediaStorageNotification( 
						        com.android.internal.R.string.external_storage_unplug_notification_title,
						        com.android.internal.R.string.external_storage_unplug_notification_message,
						        com.android.internal.R.drawable.stat_sys_warning,
						        true, false, null);
                        }
                    }
    ...
    void updateUsbMassStorageNotification(boolean available) {
        ...
        if (available) {
            ...
            if (!(Resources.getSystem().getBoolean(com.android.internal.R.bool.config_storage_notification))){
                ...
                setUsbStorageNotification(0, 0, 0, true, false, null);
            }
        }
    }
